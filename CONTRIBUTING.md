Contributing to Brewhaust Core
============================

The Brewhaust Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Brewhaust Core project, and is not to be
confused with overall Brewhaust Network Protocol consensus changes.

Whether a pull request is merged into Brewhaust Core rests with the project merge
...
The project leader is the release manager for each Brewhaust Core release.
