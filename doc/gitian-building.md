...
git clone https://github.com/brewhaust-crypto/brewhaust.git
cd brewhaust
...
```bash
    ...
    From https://github.com/brewhaust-crypto/brewhaust
...
[brewhaust/gitian.sigs](https://github.com/brewhaust-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
