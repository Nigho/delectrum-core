...
In order to support loading of multiple wallets in brewhaust-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is brewhaust.cpp.
...
Changes to brewhaust.cpp
----------------------
brewhaust.cpp is the entry point into brewhaust-qt, and as such, will require some minor modifications to provide hooks for
