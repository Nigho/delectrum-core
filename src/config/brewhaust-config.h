/* src/config/brewhaust-config.h.  Generated from brewhaust-config.h.in by configure.  */
/* src/config/brewhaust-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.brewhaust.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Brewhaust Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Brewhaust Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "brewhaust"
