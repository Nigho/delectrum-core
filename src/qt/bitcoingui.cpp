                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Brewhaust Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBRU"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Brewhaust Core"), this);
    aboutAction->setStatusTip(tr("Show information about Brewhaust Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Brewhaust Core help message to get a list with possible Brewhaust command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Brewhaust Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Brewhaust Core"); // default title
