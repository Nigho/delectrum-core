 ...
 */
    ...
    typeWidget->addItem(tr("Received Dltr from zBRU"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBRU"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBRU));
