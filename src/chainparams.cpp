...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000a4a32fec26e2bdbc9e5a74babce40464cfd4a5e5d20c6bd8527bd569c77"))
    (3, uint256("0x00000bc0f2507ee52a23737c3615b9d1040c643d3744f540d6db1ae6b4acc79b"));
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 30 * 60; // Brewhaust: 1 day
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("042d13c016ed91528241bcff222989769417eb10cdb679228c91e26e26900eb9fd053cd9f16a9a2894ad5ebbd551be1a4bd23bd55023679be17f0bd3a16e6fbeba") << OP_CHECKSIG;
        ...
        genesis.nNonce = 6226835;

        hashGenesisBlock = uint256("0x00000a4a32fec26e2bdbc9e5a74babce40464cfd4a5e5d20c6bd8527bd569c77");
        ...
        assert(hashGenesisBlock == uint256("0x00000a4a32fec26e2bdbc9e5a74babce40464cfd4a5e5d20c6bd8527bd569c77"));
        assert(genesis.hashMerkleRoot == uint256("0xf73cb23875fa3905539111f68a92edfd633d53eecb69e62cd0d22d8e590580f8"));
        ...
        strSporkKey = "483045022100b75fa4fd1e48bfdd722fa9e0c84e72d7ad0ead4443783a6fe2cb13ada96d2e0602201e2d8dc079455d9b1747bf5d4bcf73d96ed779d7af53e7225bb450e5abfe57d101";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Brewhaust: 1 day
        nTargetSpacing = 1 * 60;  // Brewhaust: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet brewhaust addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet brewhaust script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Brewhaust: 1 day
        nTargetSpacing = 1 * 60;        // Brewhaust: 1 minutes
